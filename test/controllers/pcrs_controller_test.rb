...
class PcrsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pcr" do
    assert_difference("Pcr.count") do
      post pcrs_url, params: { pcr: { admitted_at: @pcr.admitted_at, examined_at: @pcr.examined_at, examined_result: @pcr.examined_result, inpatient_seq: @pcr.inpatient_seq, is_specail_ward: @pcr.is_specail_ward, order_code: @pcr.order_code, patient_id: @pcr.patient_id, patient_name: @pcr.patient_name, patient_no: @pcr.patient_no, positived_days: @pcr.positived_days, reported_at: @pcr.reported_at, vs_doctor_id: @pcr.vs_doctor_id, vs_doctor_name: @pcr.vs_doctor_name, ward_bed: @pcr.ward_bed } }
    end
