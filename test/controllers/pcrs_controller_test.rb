...
class PcrsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pcr" do
    assert_difference("Pcr.count") do
      post pcrs_url, params: { pcr: { admitted_at: @pcr.admitted_at, examined_at: @pcr.examined_at, examined_result: @pcr.examined_result, inpatient_seq: @pcr.inpatient_seq, is_special_ward: @pcr.is_special_ward, order_code: @pcr.order_code, patient_idno: @pcr.patient_idno, patient_name: @pcr.patient_name, patient_no: @pcr.patient_no, positived_days: @pcr.positived_days, reported_at: @pcr.reported_at, vs_doctor_name: @pcr.vs_doctor_name, vs_doctor_uid: @pcr.vs_doctor_uid, ward_bed: @pcr.ward_bed } }
    end
